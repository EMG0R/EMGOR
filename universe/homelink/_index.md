...
tags: [raspberry-pi, home-automation, agent, chat, in-progress]
updated: 2026-08-03
draft: true
---

<!-- SUPERSEDED — renamed to universe/server/_index.md -->

<!--
  launch: not set yet. When the real chat interface exists as an in-repo page
  (e.g. homelink.html), set `launch: homelink.html` here so clicking this
...
Its name is **neptr Smart Control** — not to be confused with NEPTR the instrument, and not the same "neptr" that talks with SPEAK's voice. Same household, different job, easy to mix up on purpose.
...
- A live agent running locally on the home Pi, with eyes on lighting, plants, and network state.
