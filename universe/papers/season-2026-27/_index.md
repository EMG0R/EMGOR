---
id: emgor.papers.season-2026-27
title: 2026-2027 SEASON
blurb: The work that ships this year — the thesis, the three papers under it, and two that run past it
parent: emgor.papers
size: 2
tags: [research, writing, thesis, rotura, nime, icmc, linux-audio]
updated: 2026-09-21
draft: false
---
...
**[Workflow of a Modern Digital Luthier](/papers/season-2026-27/digital-luthier)** — the methodology. A process report for *ROTURA*, built on two case studies: NEPTR and BOUBA. This is the paper that states the argument directly.

**[DemiurgeOS](/papers/season-2026-27/demiurgeos)** — the foundation. A flashable, audio-first OS for the Raspberry Pi 5 and the modern successor to CCRMA's Satellite. Running today, and the platform everything else stands on.
...
**[NAM × Csound](/papers/season-2026-27/nam-csound)** — finished and submitted. `NAMProcess` brings real-time Neural Amp Modeler inference into Csound as a native opcode, with live dry-referenced volume compensation. The venue slipped to 2027; the work did not. It runs inside DEMIURGE and inside NEPTR today.
